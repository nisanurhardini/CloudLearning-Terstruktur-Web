...
-- -----------------------------------------------------
-- Table `tubes_impal`.`jwb_quiz`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tubes_impal`.`jwb_quiz` ;

CREATE  TABLE IF NOT EXISTS `tubes_impal`.`jwb_quiz` (
  `id_jwb` INT NOT NULL AUTO_INCREMENT ,
  `jawaban` VARCHAR(45) NOT NULL ,
  `id_soal` INT NOT NULL ,
  PRIMARY KEY (`id_jwb`) ,
  CONSTRAINT `FK_id_soal_jwb_quiz`
    FOREIGN KEY (`id_soal` )
    REFERENCES `tubes_impal`.`bank_soal` (`id_soal` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `FK_id_soal_jwb_quiz_idx` ON `tubes_impal`.`jwb_quiz` (`id_soal` ASC) ;
...
-- -----------------------------------------------------
-- Data for table `tubes_impal`.`fakultas`
-- -----------------------------------------------------
START TRANSACTION;
USE `tubes_impal`;
INSERT INTO `tubes_impal`.`fakultas` (`id_fak`, `kode_fakultas`, `nama_fakultas`) VALUES (1, 'FIF', 'S1 Teknik Informatika');
INSERT INTO `tubes_impal`.`fakultas` (`id_fak`, `kode_fakultas`, `nama_fakultas`) VALUES (2, 'FIF', 'S1 Ilmu Komputasi');
INSERT INTO `tubes_impal`.`fakultas` (`id_fak`, `kode_fakultas`, `nama_fakultas`) VALUES (3, 'FIK', 'S1 Desain Komunikasi Visual');

COMMIT;

-- -----------------------------------------------------
-- Data for table `tubes_impal`.`kelas`
-- -----------------------------------------------------
START TRANSACTION;
USE `tubes_impal`;
INSERT INTO `tubes_impal`.`kelas` (`kelas_id`, `nama_kelas`, `id_fak`) VALUES (1, 'IF-39-12', 1);
INSERT INTO `tubes_impal`.`kelas` (`kelas_id`, `nama_kelas`, `id_fak`) VALUES (2, 'IK-39-12', 2);
INSERT INTO `tubes_impal`.`kelas` (`kelas_id`, `nama_kelas`, `id_fak`) VALUES (3, 'MM-38-F', 3);

COMMIT;

-- -----------------------------------------------------
-- Data for table `tubes_impal`.`mata_kuliah`
-- -----------------------------------------------------
START TRANSACTION;
USE `tubes_impal`;
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `nama_materi`, `pathfile`) VALUES (1, 'CH32I2', 'Probabilitas Statistika', 'Probablilitas', NULL);
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `nama_materi`, `pathfile`) VALUES (2, 'CH21J3', 'Kalkulus II', 'Integral Lipat-Lipat', NULL);
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `nama_materi`, `pathfile`) VALUES (3, 'CH52S1', 'Struktur Data', 'Tree', NULL);
