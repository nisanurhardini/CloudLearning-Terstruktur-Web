...
START TRANSACTION;
USE `tubes_impal`;
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `pathfile`) VALUES (1, 'CH32I2', 'Probabilitas Statistika', NULL);
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `pathfile`) VALUES (2, 'CH21J3', 'Kalkulus II', NULL);
INSERT INTO `tubes_impal`.`mata_kuliah` (`id_matkul`, `kode_matkul`, `nama_matkul`, `pathfile`) VALUES (3, 'CH52S1', 'Struktur Data', NULL);
